  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="index.html"><img src="assets/images/rec.svg" alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="assets/images/bp2.svg" alt="logo" /></a>
      </div>
      <ul class="nav">
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Demographic form</h4>
                  <p class="card-description"></p>
                  <form class="forms-sample" id="patientForm" action="process/addPatient.php" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input required type="text" class="form-control" name="fname" placeholder="Type here.." />
                    </div>
                    <div class="form-group">
                      <label>Middle name</label>
                      <input required type="text" class="form-control" name="mname" placeholder="Type here.." />
                    </div>
                    <div class="form-group">
                      <label>Date of Birth</label>
                      <input required type="date" class="form-control" name="dob" placeholder="MM-DD-YYYY" pattern="\d{2}-\d{2}-\d{4}" />
                    </div>

                    <button name="addPatient" type="submit" class="btn btn-primary me-2">
                      Submit
                    </button>
